...
public class User {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) // Ensures auto-increment for the userId
    @Column(name = "userId", updatable = false, nullable = false) // Ensures userId is not updated and is not null
    private Long userId;
